...
from src.services.context_extractor import ContextExtractor, EDirection, ExtractedContext
    ...
    def run(self, input_files: list[Path]) -> MainManagerResult:
        ...
        if precheck_result.should_return_empty_findings:
            return MainManagerResult(
                direction=extracted_context.direction,
        ...
        agent_result: AgentResult = self.agent_service.find_missing_details(extracted_context)
